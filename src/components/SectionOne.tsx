                ...
                <div className="w-100 h-full mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
                    <div className="h-full grid items-center gap-12 lg:grid-cols-2 justify-normal">
                        ...
                        <div className="w-full text-center items-center">
                            ...
                            <br />
                            <a href='#sectionThree'><div className="w-fit m-auto text-center items-center justify-center mt-[3vw]"> <ButtonAvg label='Get started' iconRight={<div className='pl-2 items-center flex justify-center m-auto'><img className='rightBtnArrow' src={arrowRIght} width={30} title="arrow right" alt="pointRight" /></div>} /></div></a>
                        </div>
                    </div>
                </div>
            </div>
