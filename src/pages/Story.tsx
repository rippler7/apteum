        ...
        <>
            <section className="relative w-full md:h-fit sm:h-max flex items-end justify-start text-left text-white z-1 pt-20">
                ...
                <div className="img-content relative py-5 w-full max-w-sm md:max-w-5xl">
                    ...
                    <h3 className="text-3xl px-10">Remote hiring is a practical alternative and long-term solution to business growth and development—but it should be done the right way. At Apteum, that means treating all clients, collaborators, contractors and staff with the utmost respect.
                    </h3>
                </div>
                </div>
            </section>
            ...
            <div className='flex flex-col justify-evenly h-full w-10/12 mx-auto text-left align-items'>
                    <div className='tagline w-full px-10 text-xl'>                        
                        <h4>Initially created to provide operational support for our growing businesses, we quickly realised we had a talent acquisition service that could benefit companies across Australia and the world. But rather than follow the traditional approach to outsourcing, we <span className="realistic-marker-highlight"><mark>wanted to build genuine and lasting relationships with the people who support</mark></span>our business.</h4>
                        <br />
                        <h4>In 2023, we established our own office in Cebu City, where we have <span className="realistic-marker-highlight"><mark>a team of 20+ wonderful people with a wide breadth of skill and specialisation.</mark></span> Situated on Cebu Island, in South-Central Philippines, Cebu is a vibrant and evolving city. With a population of more than one million, and a median age of 25, this rapidly growing city plays a vital role in the Philippines' emerging economy.</h4>
                        <br />
                        <h4>Our office is based in the Cebu I.T. Park, a district focused on international business that services companies around the world. Due to the professional opportunities available, the area attracts talented people from across the country.  <span className="realistic-marker-highlight"><mark>We couldn't be more pleased to be here.</mark></span> As our business continues to grow, we remain focused on developing relationships with like-minded clients who align with our values and share our enthusiasm for a more ethical approach to outsourcing.</h4>
                    </div>
            </div>
            </section>
