        ...
        <>
            ...
            <div className='flex flex-col justify-evenly h-full w-10/12 mx-auto text-left align-items'>
                    <div className='tagline w-full px-10 text-xl'>                        
                        ...
                        <br />
                        <h4>Our office is based in the Cebu I.T. Park, a district focused on international business that services companies around the world. Due to the professional opportunities available, the area attracts talented people from across the country.  <span className="text-highlight">We couldn't be more pleased to be here.</span> As our business continues to grow, we remain focused on developing relationships with like-minded clients who align with our values and share our enthusiasm for a more ethical approach to outsourcing.</h4>
                    </div>
            </div>
            </section>
